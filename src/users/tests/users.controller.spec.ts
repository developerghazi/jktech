...
describe('UsersController', () => {
  ...
  describe('updateRole', () => {
    it('should update user role successfully', async () => {
      ...
      const result = await controller.updateRole(userId, updateRoleDto,req);
    ...
    it('should handle errors when updating role', async () => {
      ...
      await expect(controller.updateRole(userId, updateRoleDto,req))
    ...
    it('should convert string id to number when updating role', async () => {
      ...
      await controller.updateRole(userId, updateRoleDto,req);
